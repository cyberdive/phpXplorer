...
class pxCLS_action_directory_detailed extends pxCLS_action_directory{

	function pxCLS_action_directory_detailed(){
	
		parent::pxCLS_action_directory();

		$this->aColumns = array("checkbox", "image", "sFile", "iSize", "iModified", "sType", "permissions", "owner", "group", "action");
		$this->aColumnAlign = array("left", "center", "left", "right", "left", "left", "right", "left", "left", "right");
		
		$this->aColumnWidth["sFile"] = 150;
		$this->aColumnWidth["iSize"] = 60;
		$this->aColumnWidth["iModified"] = 110;
		$this->aColumnWidth["sType"] = 150;
		$this->aColumnWidth["permissions"] = 75;
		$this->aColumnWidth["owner"] = 60;
		$this->aColumnWidth["group"] = 50;
	...
	function getTableHeadHTML(){
		...
		return parent::getTableHeadHTML()
			    ...
			    . $this->getColumnHead("permissions", false) . $this->sSizer
			    . $this->getColumnHead("owner", false) . $this->sSizer
			    . $this->getColumnHead("group", false) . $this->sSizer
